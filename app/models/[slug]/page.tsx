  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-8 md:grid-cols-2 items-center">
            ...
            <div>
              ...
              <h1 className="mb-4 text-4xl font-bold text-foreground sm:text-5xl">{model.name}</h1>
              <p className="text-lg text-foreground/70">
                Master your {model.name} with our comprehensive video tutorials. Learn everything from basic setup to
                advanced techniques.
              </p>
      ...
      <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-foreground">Tutorials for {model.name}</h2>
          <p className="mt-2 text-foreground/70">Step-by-step guides to help you get the most out of your machine</p>
        </div>
          ...
          {model.tutorials.map((tutorial) => (
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-gray-900 to-gray-700">
                ...
                <Link href={tutorial.youtubeUrl} target="_blank" rel="noopener noreferrer">
                  <Image
                    src={model.image}
                    alt={tutorial.title}
                    fill
              ...
              <div className="p-6">
                ...
                <h3 className="mb-3 text-lg font-bold text-foreground line-clamp-2">{tutorial.title}</h3>
